...
rules = {
    "acc": lambda value, acc, cursor: (cursor + 1, acc + value),
    "jmp": lambda value, acc, cursor: (cursor + value, acc),
    "nop": lambda value, acc, cursor: (cursor + 1, acc),
}
...
def main(instructions):
    ...
    while cursor not in processed:
        ...
        cursor, acc = rules[instruction](int(value), acc, cursor)
